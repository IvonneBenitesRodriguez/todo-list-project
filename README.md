...
The website displays the user's input and gives the functionality to add, remove and mark user's input.<br/>
...
```sh
  cd my-folder
  git clone git@github.com:myaccount/IvonneBenitesRodriguez/todo-list-list-structure
```
